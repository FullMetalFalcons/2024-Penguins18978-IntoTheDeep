...
/**
 * This is a copy of the LibFTC PIDF Controller that allows us to debug it more easily.
 * *
 ...
 */
public class FalconsPIDFController {
     ...
     */
    public FalconsPIDFController(double kp, double ki, double kd, double kf, double sp, double pv) {
        kP = kp;
        kI = ki;
        kD = kd;
        kF = kf;
    ...
    public double calculate(double pv) {
        ...
        // returns u(t) in ticks/sec
        double kP_calc = kP * errorVal_p;  //P units is 1/sec
        double kI_calc = kI * totalError;  //I units is
        double kD_calc = kD * errorVal_v;
        double kF_calc = kF * setPoint;
